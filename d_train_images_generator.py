...
cls_names = ["Speed_limit_5", "Speed_limit_15", "Speed_limit_30",
             ...
             "No Overhead", "No U-turn", "No Motor vehicle", "No whistle", "Unrestricted speed_40",
             "Unrestricted speed_50",
             "Straight or turn right", "Straight", "Turn left", "Turn left or turn right", "Turn right",
...
# 所要识别的交通指示牌
target_class = ["031", "042", "052"]
classes_name = ["U-turn", "Go slow", "stop", "background"]
classes_num = {"U-turn": 0, "Go slow": 1, "stop": 2, "background": 3}

SIGN_ROOT = "./"
DATA_PATH = os.path.join(SIGN_ROOT, 'data/a_cropped_images/')
...
def produce_proposals(xml_dir, write_dir, square=False, min_size=30):
    ...
    for xml_file in os.listdir(xml_dir):
        ...
        if len(labels) == 0:
            ...
            proposal_num = produce_pos_proposals(img_path, write_dir, labels, min_size, square=True,
...
if __name__ == "__main__":
    xml_dir = "./data/b_image_xmls"
    save_dir = "./data/d_train_images"
